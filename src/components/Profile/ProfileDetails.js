...
function ProfileDetails() {
    ...
    const updateUserProfileDetails = (e) => {
        ...
        axios.put(process.env.REACT_APP_API_URL + '/profile', {
        ...
        <div className="account-form">
            ...
            <form action="POST" onSubmit={updateUserProfileDetails}>
                <div className="form-section">
                    ...
                    <input type="number" id="age" name="age" value={profileDataValue.age || ''} onChange={handleChange} />
                </div>
                <div className="form-section">
                    <label htmlFor="gender">Gender:</label>
                    <select id="gender" name="gender" value={profileDataValue.gender || ''} onChange={handleChange}>
                ...
                <div className="form-section">
                    ...
                    <input type="number" id="height" name="height" value={profileDataValue.height || ''} onChange={handleChange} />
                </div>
                <div className="form-section">
                    <label htmlFor="weight">Weight (kg):</label>
                    <input type="number" id="weight" name="weight" value={profileDataValue.weight || ''} onChange={handleChange} />
                </div>
                <div className="form-section">
                    <label htmlFor="dailyIntakeCalorie">Daily Intake Calorie:</label>
                    <input type="number" id="dailyIntakeCalorie" name="dailyIntakeCalorie" value={profileDataValue.dailyIntakeCalorie || ''} onChange={handleChange} />
                </div>
                <div className="form-section">
